# OS2Web Meetings EDOC Drupal module [![Build Status](https://travis-ci.org/OS2web/os2web_meetings_edoc.svg?branch=master)](https://travis-ci.org/OS2web/os2web_meetings_edoc)
